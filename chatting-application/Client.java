...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        ImageIcon i4 = new ImageIcon(getClass().getResource("/icons/bella.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            dout.writeUTF(out);
            System.out.println("Message sent: " + out); // Debugging statement
    ...
    public static void main(String[] args) {
        ...
        try {
            Socket s = new Socket("127.0.0.1", 6002); // Ensure this IP is correct
            System.out.println("Client started, connected to the server...");
            ...
            while (true) {
                ...
                System.out.println("Message received: " + msg); // Debugging statement

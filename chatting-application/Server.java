...
public class Server implements ActionListener{
    ...
    Server (){
       ...
       ImageIcon i4 = new ImageIcon(getClass().getResource("/icons/edward.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if (dout != null) {  // Check if dout is initialized
                dout.writeUTF(out);
            } else {
                JOptionPane.showMessageDialog(f, "No client connected. Please wait for a client to connect.", "Connection Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
